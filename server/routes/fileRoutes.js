...
import { uploadFile, getUserFiles, deleteFile, getAllFiles, adminDeleteFile, viewFile, getFileInfoForShare, streamFileView } from "../controllers/fileController.js"
...
router.get("/:id/view", streamFileView)
